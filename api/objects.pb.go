...
type Service struct {
	...
	// StaticInfo contains information for the service if its spec specifies
	// "static" mode, in which case this info records which node it is assigned
	// to and its network identity.
	StaticInfo *StaticInfo `protobuf:"bytes,12,opt,name=static_info,json=staticInfo" json:"static_info,omitempty"`
}
...
type PeerGroup struct {
	ID   string        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta Meta          `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	Spec PeerGroupSpec `protobuf:"bytes,3,opt,name=spec" json:"spec"`
	// Runtime state of peer group endpoint, providing the tasks in the peer
	// group with a virtual IP
	Endpoint *Endpoint `protobuf:"bytes,4,opt,name=endpoint" json:"endpoint,omitempty"`
}

func (m *PeerGroup) Reset()                    { *m = PeerGroup{} }
func (*PeerGroup) ProtoMessage()               {}
func (*PeerGroup) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{3} }

type CertificateAuthority struct {
	ID   string                   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta Meta                     `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	Spec CertificateAuthoritySpec `protobuf:"bytes,3,opt,name=spec" json:"spec"`
	// Key is the CA private key.
	Key []byte `protobuf:"bytes,4,opt,name=key,proto3" json:"key,omitempty"`
	// Cert is the root CA certificate.
...
func (*CertificateAuthority) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{4} }
...
func (*Endpoint) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{5} }
...
type Endpoint_VirtualIP struct {
	...
	// A name and ID is used to set the DNS entry which maps to this
	// virtual IP. If not specified, the service ID and name are used.
...
func (*Endpoint_VirtualIP) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{5, 0} }
...
type Task struct {
	...
	IsStandalone             bool               `protobuf:"varint,16,opt,name=is_standalone,json=isStandalone,proto3" json:"is_standalone,omitempty"`
	MaterializedConfigs      []*ConfigReference `protobuf:"bytes,17,rep,name=materialized_configs,json=materializedConfigs" json:"materialized_configs,omitempty"`
}

func (m *Task) Reset()                    { *m = Task{} }
func (*Task) ProtoMessage()               {}
func (*Task) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{6} }
...
func (*NetworkAttachment) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{7} }
...
func (*Cluster) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{9} }
...
func (*Secret) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{10} }
...
func (*Config) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{11} }
...
func (*Resource) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{12} }
...
func (*Extension) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{13} }

// StaticInfo records the scheduled node ID, allocated network address, and
// status message for a static service.
type StaticInfo struct {
	Message           string             `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	NodeID            string             `protobuf:"bytes,2,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	NetworkAttachment *NetworkAttachment `protobuf:"bytes,3,opt,name=network_attachment,json=networkAttachment" json:"network_attachment,omitempty"`
}

func (m *StaticInfo) Reset()                    { *m = StaticInfo{} }
func (*StaticInfo) ProtoMessage()               {}
func (*StaticInfo) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{14} }
...
func init() {
	...
	proto.RegisterType((*PeerGroup)(nil), "docker.swarmkit.v1.PeerGroup")
	proto.RegisterType((*CertificateAuthority)(nil), "docker.swarmkit.v1.CertificateAuthority")
	...
	proto.RegisterType((*StaticInfo)(nil), "docker.swarmkit.v1.StaticInfo")
}
...
func (m *Service) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.StaticInfo != nil {
		m.StaticInfo = &StaticInfo{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.StaticInfo, o.StaticInfo)
	}
}

func (m *PeerGroup) Copy() *PeerGroup {
	if m == nil {
		return nil
	}
	o := &PeerGroup{}
...
func (m *PeerGroup) CopyFrom(src interface{}) {
...
func (m *CertificateAuthority) Copy() *CertificateAuthority {
	if m == nil {
		return nil
	}
...
func (m *CertificateAuthority) CopyFrom(src interface{}) {

	o := src.(*CertificateAuthority)
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Meta, &o.Meta)
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Spec, &o.Spec)
	if o.Key != nil {
...
func (m *Task) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.MaterializedConfigs != nil {
		m.MaterializedConfigs = make([]*ConfigReference, len(o.MaterializedConfigs))
		for i := range m.MaterializedConfigs {
			m.MaterializedConfigs[i] = &ConfigReference{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.MaterializedConfigs[i], o.MaterializedConfigs[i])
		}
	}
...
func (m *StaticInfo) Copy() *StaticInfo {
	if m == nil {
		return nil
	}
	o := &StaticInfo{}
...
func (m *StaticInfo) CopyFrom(src interface{}) {

	o := src.(*StaticInfo)
	*m = *o
	if o.NetworkAttachment != nil {
		m.NetworkAttachment = &NetworkAttachment{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.NetworkAttachment, o.NetworkAttachment)
	}
}
...
func (m *Service) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StaticInfo != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.StaticInfo.Size()))
		n18, err := m.StaticInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *CertificateAuthority) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Key) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintObjects(dAtA, i, uint64(len(m.Key)))
		i += copy(dAtA[i:], m.Key)
	}
	if len(m.Cert) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(len(m.Cert)))
...
func (m *Task) MarshalTo(dAtA []byte) (int, error) {
	...
	n28, err := m.ServiceAnnotations.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n28
	...
	if m.Endpoint != nil {
		...
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.Endpoint.Size()))
		n30, err := m.Endpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.SpecVersion != nil {
		...
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.SpecVersion.Size()))
		n32, err := m.SpecVersion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if len(m.MaterializedConfigs) > 0 {
		for _, msg := range m.MaterializedConfigs {
			dAtA[i] = 0x8a
			i++
			dAtA[i] = 0x1
			i++
...
func (m *NetworkAttachment) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Network != nil {
		...
		n33, err := m.Network.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *Network) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DriverState != nil {
		...
		n36, err := m.DriverState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
	...
	if m.IPAM != nil {
		...
		n37, err := m.IPAM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *Cluster) MarshalTo(dAtA []byte) (int, error) {
	...
	n40, err := m.RootCA.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
...
func (m *StaticInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StaticInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Message) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintObjects(dAtA, i, uint64(len(m.Message)))
	...
	if m.NetworkAttachment != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.NetworkAttachment.Size()))
		n51, err := m.NetworkAttachment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *Task) Size() (n int) {
	...
	if len(m.MaterializedConfigs) > 0 {
		for _, e := range m.MaterializedConfigs {
			l = e.Size()
...
type PeerGroupCheckFunc func(t1, t2 *PeerGroup) bool

type EventCreatePeerGroup struct {
	PeerGroup *PeerGroup
	Checks    []PeerGroupCheckFunc
}

func (e EventCreatePeerGroup) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventCreatePeerGroup)
	if !ok {
		return false
	}

	for _, check := range e.Checks {
		if !check(e.PeerGroup, typedEvent.PeerGroup) {
			return false
		}
	}
	return true
...
type EventUpdatePeerGroup struct {
	PeerGroup    *PeerGroup
	OldPeerGroup *PeerGroup
	Checks       []PeerGroupCheckFunc
}

func (e EventUpdatePeerGroup) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventUpdatePeerGroup)
	if !ok {
		return false
	}
...
type EventDeletePeerGroup struct {
	PeerGroup *PeerGroup
	Checks    []PeerGroupCheckFunc
}

func (e EventDeletePeerGroup) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventDeletePeerGroup)
	if !ok {
		return false
	}
...
func (m *PeerGroup) CopyStoreObject() StoreObject {
	return m.Copy()
}

func (m *PeerGroup) GetMeta() Meta {
	return m.Meta
}

func (m *PeerGroup) SetMeta(meta Meta) {
	m.Meta = meta
}

func (m *PeerGroup) GetID() string {
	return m.ID
}

func (m *PeerGroup) EventCreate() Event {
	return EventCreatePeerGroup{PeerGroup: m}
}

func (m *PeerGroup) EventUpdate(oldObject StoreObject) Event {
	if oldObject != nil {
		return EventUpdatePeerGroup{PeerGroup: m, OldPeerGroup: oldObject.(*PeerGroup)}
	} else {
		return EventUpdatePeerGroup{PeerGroup: m}
	}
}

func (m *PeerGroup) EventDelete() Event {
	return EventDeletePeerGroup{PeerGroup: m}
}

func PeerGroupCheckID(v1, v2 *PeerGroup) bool {
	return v1.ID == v2.ID
}

func PeerGroupCheckIDPrefix(v1, v2 *PeerGroup) bool {
	return strings.HasPrefix(v2.ID, v1.ID)
}

func PeerGroupCheckName(v1, v2 *PeerGroup) bool {
	return v1.Spec.Annotations.Name == v2.Spec.Annotations.Name
}

func PeerGroupCheckNamePrefix(v1, v2 *PeerGroup) bool {
	return strings.HasPrefix(v2.Spec.Annotations.Name, v1.Spec.Annotations.Name)
}

func PeerGroupCheckCustom(v1, v2 *PeerGroup) bool {
	return checkCustom(v1.Spec.Annotations, v2.Spec.Annotations)
}

func PeerGroupCheckCustomPrefix(v1, v2 *PeerGroup) bool {
	return checkCustomPrefix(v1.Spec.Annotations, v2.Spec.Annotations)
}

func ConvertPeerGroupWatch(action WatchActionKind, filters []*SelectBy) ([]Event, error) {
	var (
		m          PeerGroup
		checkFuncs []PeerGroupCheckFunc
	)
	...
	for _, filter := range filters {
		...
		case *SelectBy_ID:
			...
			m.ID = v.ID
			checkFuncs = append(checkFuncs, PeerGroupCheckID)
		case *SelectBy_IDPrefix:
			if m.ID != "" {
				return nil, errConflictingFilters
			}
			m.ID = v.IDPrefix
			checkFuncs = append(checkFuncs, PeerGroupCheckIDPrefix)
		case *SelectBy_Name:
			if m.Spec.Annotations.Name != "" {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Name = v.Name
			checkFuncs = append(checkFuncs, PeerGroupCheckName)
		case *SelectBy_NamePrefix:
			if m.Spec.Annotations.Name != "" {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Name = v.NamePrefix
			checkFuncs = append(checkFuncs, PeerGroupCheckNamePrefix)
		case *SelectBy_Custom:
			if len(m.Spec.Annotations.Indices) != 0 {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Indices = []IndexEntry{{Key: v.Custom.Index, Val: v.Custom.Value}}
			checkFuncs = append(checkFuncs, PeerGroupCheckCustom)
		case *SelectBy_CustomPrefix:
			if len(m.Spec.Annotations.Indices) != 0 {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Indices = []IndexEntry{{Key: v.CustomPrefix.Index, Val: v.CustomPrefix.Value}}
			checkFuncs = append(checkFuncs, PeerGroupCheckCustomPrefix)
		}
	}
	var events []Event
	if (action & WatchActionKindCreate) != 0 {
		events = append(events, EventCreatePeerGroup{PeerGroup: &m, Checks: checkFuncs})
	}
	if (action & WatchActionKindUpdate) != 0 {
		events = append(events, EventUpdatePeerGroup{PeerGroup: &m, Checks: checkFuncs})
	}
	if (action & WatchActionKindRemove) != 0 {
		events = append(events, EventDeletePeerGroup{PeerGroup: &m, Checks: checkFuncs})
	}
	if len(events) == 0 {
		return nil, errUnrecognizedAction
	}
...
type PeerGroupIndexerByID struct{}

func (indexer PeerGroupIndexerByID) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer PeerGroupIndexerByID) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer PeerGroupIndexerByID) FromObject(obj interface{}) (bool, []byte, error) {
	m := obj.(*PeerGroup)
	return true, []byte(m.ID + "\x00"), nil
}

type PeerGroupIndexerByName struct{}

func (indexer PeerGroupIndexerByName) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer PeerGroupIndexerByName) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer PeerGroupIndexerByName) FromObject(obj interface{}) (bool, []byte, error) {
	m := obj.(*PeerGroup)
	val := m.Spec.Annotations.Name
	return true, []byte(strings.ToLower(val) + "\x00"), nil
}

type PeerGroupCustomIndexer struct{}

func (indexer PeerGroupCustomIndexer) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer PeerGroupCustomIndexer) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer PeerGroupCustomIndexer) FromObject(obj interface{}) (bool, [][]byte, error) {
	m := obj.(*PeerGroup)
	return customIndexer("", &m.Spec.Annotations)
}

type CertificateAuthorityCheckFunc func(t1, t2 *CertificateAuthority) bool

type EventCreateCertificateAuthority struct {
	CertificateAuthority *CertificateAuthority
	Checks               []CertificateAuthorityCheckFunc
}

func (e EventCreateCertificateAuthority) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventCreateCertificateAuthority)
	if !ok {
		return false
	}

	for _, check := range e.Checks {
		if !check(e.CertificateAuthority, typedEvent.CertificateAuthority) {
			return false
		}
	}
	return true
...
type EventUpdateCertificateAuthority struct {
	CertificateAuthority    *CertificateAuthority
	OldCertificateAuthority *CertificateAuthority
	Checks                  []CertificateAuthorityCheckFunc
}

func (e EventUpdateCertificateAuthority) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventUpdateCertificateAuthority)
	if !ok {
		return false
	}
...
type EventDeleteCertificateAuthority struct {
	CertificateAuthority *CertificateAuthority
	Checks               []CertificateAuthorityCheckFunc
}

func (e EventDeleteCertificateAuthority) Matches(apiEvent github_com_docker_go_events.Event) bool {
	typedEvent, ok := apiEvent.(EventDeleteCertificateAuthority)
	if !ok {
		return false
	}
...
func (m *CertificateAuthority) CopyStoreObject() StoreObject {
	return m.Copy()
}

func (m *CertificateAuthority) GetMeta() Meta {
	return m.Meta
}

func (m *CertificateAuthority) SetMeta(meta Meta) {
	m.Meta = meta
}

func (m *CertificateAuthority) GetID() string {
	return m.ID
}

func (m *CertificateAuthority) EventCreate() Event {
	return EventCreateCertificateAuthority{CertificateAuthority: m}
}

func (m *CertificateAuthority) EventUpdate(oldObject StoreObject) Event {
	if oldObject != nil {
		return EventUpdateCertificateAuthority{CertificateAuthority: m, OldCertificateAuthority: oldObject.(*CertificateAuthority)}
	} else {
		return EventUpdateCertificateAuthority{CertificateAuthority: m}
	}
}

func (m *CertificateAuthority) EventDelete() Event {
	return EventDeleteCertificateAuthority{CertificateAuthority: m}
}

func CertificateAuthorityCheckID(v1, v2 *CertificateAuthority) bool {
	return v1.ID == v2.ID
}

func CertificateAuthorityCheckIDPrefix(v1, v2 *CertificateAuthority) bool {
	return strings.HasPrefix(v2.ID, v1.ID)
}

func CertificateAuthorityCheckName(v1, v2 *CertificateAuthority) bool {
	return v1.Spec.Annotations.Name == v2.Spec.Annotations.Name
}

func CertificateAuthorityCheckNamePrefix(v1, v2 *CertificateAuthority) bool {
	return strings.HasPrefix(v2.Spec.Annotations.Name, v1.Spec.Annotations.Name)
}

func CertificateAuthorityCheckCustom(v1, v2 *CertificateAuthority) bool {
	return checkCustom(v1.Spec.Annotations, v2.Spec.Annotations)
}

func CertificateAuthorityCheckCustomPrefix(v1, v2 *CertificateAuthority) bool {
	return checkCustomPrefix(v1.Spec.Annotations, v2.Spec.Annotations)
}

func ConvertCertificateAuthorityWatch(action WatchActionKind, filters []*SelectBy) ([]Event, error) {
	var (
		m          CertificateAuthority
		checkFuncs []CertificateAuthorityCheckFunc
	)
	...
	for _, filter := range filters {
		...
		case *SelectBy_ID:
			...
			m.ID = v.ID
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckID)
		case *SelectBy_IDPrefix:
			if m.ID != "" {
				return nil, errConflictingFilters
			}
			m.ID = v.IDPrefix
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckIDPrefix)
		case *SelectBy_Name:
			if m.Spec.Annotations.Name != "" {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Name = v.Name
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckName)
		case *SelectBy_NamePrefix:
			if m.Spec.Annotations.Name != "" {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Name = v.NamePrefix
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckNamePrefix)
		case *SelectBy_Custom:
			if len(m.Spec.Annotations.Indices) != 0 {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Indices = []IndexEntry{{Key: v.Custom.Index, Val: v.Custom.Value}}
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckCustom)
		case *SelectBy_CustomPrefix:
			if len(m.Spec.Annotations.Indices) != 0 {
				return nil, errConflictingFilters
			}
			m.Spec.Annotations.Indices = []IndexEntry{{Key: v.CustomPrefix.Index, Val: v.CustomPrefix.Value}}
			checkFuncs = append(checkFuncs, CertificateAuthorityCheckCustomPrefix)
		}
	}
	var events []Event
	if (action & WatchActionKindCreate) != 0 {
		events = append(events, EventCreateCertificateAuthority{CertificateAuthority: &m, Checks: checkFuncs})
	}
	if (action & WatchActionKindUpdate) != 0 {
		events = append(events, EventUpdateCertificateAuthority{CertificateAuthority: &m, Checks: checkFuncs})
	}
	if (action & WatchActionKindRemove) != 0 {
		events = append(events, EventDeleteCertificateAuthority{CertificateAuthority: &m, Checks: checkFuncs})
	}
	if len(events) == 0 {
		return nil, errUnrecognizedAction
	}
...
type CertificateAuthorityIndexerByID struct{}

func (indexer CertificateAuthorityIndexerByID) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer CertificateAuthorityIndexerByID) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer CertificateAuthorityIndexerByID) FromObject(obj interface{}) (bool, []byte, error) {
	m := obj.(*CertificateAuthority)
	return true, []byte(m.ID + "\x00"), nil
}

type CertificateAuthorityIndexerByName struct{}

func (indexer CertificateAuthorityIndexerByName) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer CertificateAuthorityIndexerByName) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer CertificateAuthorityIndexerByName) FromObject(obj interface{}) (bool, []byte, error) {
	m := obj.(*CertificateAuthority)
	val := m.Spec.Annotations.Name
	return true, []byte(strings.ToLower(val) + "\x00"), nil
}

type CertificateAuthorityCustomIndexer struct{}

func (indexer CertificateAuthorityCustomIndexer) FromArgs(args ...interface{}) ([]byte, error) {
	return fromArgs(args...)
}
func (indexer CertificateAuthorityCustomIndexer) PrefixFromArgs(args ...interface{}) ([]byte, error) {
	return prefixFromArgs(args...)
}
func (indexer CertificateAuthorityCustomIndexer) FromObject(obj interface{}) (bool, [][]byte, error) {
	m := obj.(*CertificateAuthority)
	return customIndexer("", &m.Spec.Annotations)
}
...
func NewStoreAction(c Event) (StoreAction, error) {
	...
	case EventDeleteService:
		sa.Action = StoreActionKindRemove
		sa.Target = &StoreAction_Service{Service: v.Service}
	case EventCreatePeerGroup:
		sa.Action = StoreActionKindCreate
		sa.Target = &StoreAction_PeerGroup{PeerGroup: v.PeerGroup}
	case EventUpdatePeerGroup:
		sa.Action = StoreActionKindUpdate
		sa.Target = &StoreAction_PeerGroup{PeerGroup: v.PeerGroup}
	case EventDeletePeerGroup:
		sa.Action = StoreActionKindRemove
		sa.Target = &StoreAction_PeerGroup{PeerGroup: v.PeerGroup}
	case EventCreateCertificateAuthority:
		sa.Action = StoreActionKindCreate
		sa.Target = &StoreAction_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}
	case EventUpdateCertificateAuthority:
		sa.Action = StoreActionKindUpdate
		sa.Target = &StoreAction_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}
	case EventDeleteCertificateAuthority:
		sa.Action = StoreActionKindRemove
		sa.Target = &StoreAction_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}
...
func EventFromStoreAction(sa StoreAction, oldObject StoreObject) (Event, error) {
	...
	case *StoreAction_PeerGroup:
		switch sa.Action {
		case StoreActionKindCreate:
			return EventCreatePeerGroup{PeerGroup: v.PeerGroup}, nil
		case StoreActionKindUpdate:
			if oldObject != nil {
				return EventUpdatePeerGroup{PeerGroup: v.PeerGroup, OldPeerGroup: oldObject.(*PeerGroup)}, nil
			} else {
				return EventUpdatePeerGroup{PeerGroup: v.PeerGroup}, nil
			}
		case StoreActionKindRemove:
			return EventDeletePeerGroup{PeerGroup: v.PeerGroup}, nil
		}
	case *StoreAction_CertificateAuthority:
		switch sa.Action {
		case StoreActionKindCreate:
			return EventCreateCertificateAuthority{CertificateAuthority: v.CertificateAuthority}, nil
		case StoreActionKindUpdate:
			if oldObject != nil {
				return EventUpdateCertificateAuthority{CertificateAuthority: v.CertificateAuthority, OldCertificateAuthority: oldObject.(*CertificateAuthority)}, nil
			} else {
				return EventUpdateCertificateAuthority{CertificateAuthority: v.CertificateAuthority}, nil
			}
		case StoreActionKindRemove:
			return EventDeleteCertificateAuthority{CertificateAuthority: v.CertificateAuthority}, nil
		}
...
func WatchMessageEvent(c Event) *WatchMessage_Event {
	...
	case EventCreatePeerGroup:
		return &WatchMessage_Event{Action: WatchActionKindCreate, Object: &Object{Object: &Object_PeerGroup{PeerGroup: v.PeerGroup}}}
	case EventUpdatePeerGroup:
		if v.OldPeerGroup != nil {
			return &WatchMessage_Event{Action: WatchActionKindUpdate, Object: &Object{Object: &Object_PeerGroup{PeerGroup: v.PeerGroup}}, OldObject: &Object{Object: &Object_PeerGroup{PeerGroup: v.OldPeerGroup}}}
		} else {
			return &WatchMessage_Event{Action: WatchActionKindUpdate, Object: &Object{Object: &Object_PeerGroup{PeerGroup: v.PeerGroup}}}
		}
	case EventDeletePeerGroup:
		return &WatchMessage_Event{Action: WatchActionKindRemove, Object: &Object{Object: &Object_PeerGroup{PeerGroup: v.PeerGroup}}}
	case EventCreateCertificateAuthority:
		return &WatchMessage_Event{Action: WatchActionKindCreate, Object: &Object{Object: &Object_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}}}
	case EventUpdateCertificateAuthority:
		if v.OldCertificateAuthority != nil {
			return &WatchMessage_Event{Action: WatchActionKindUpdate, Object: &Object{Object: &Object_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}}, OldObject: &Object{Object: &Object_CertificateAuthority{CertificateAuthority: v.OldCertificateAuthority}}}
		} else {
			return &WatchMessage_Event{Action: WatchActionKindUpdate, Object: &Object{Object: &Object_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}}}
		}
	case EventDeleteCertificateAuthority:
		return &WatchMessage_Event{Action: WatchActionKindRemove, Object: &Object{Object: &Object_CertificateAuthority{CertificateAuthority: v.CertificateAuthority}}}
	case EventCreateTask:
...
func ConvertWatchArgs(entries []*WatchRequest_WatchEntry) ([]Event, error) {
	...
	for _, entry := range entries {
		...
		case "peergroup":
			newEvents, err = ConvertPeerGroupWatch(entry.Action, entry.Filters)
		case "certificateauthority":
			newEvents, err = ConvertCertificateAuthorityWatch(entry.Action, entry.Filters)
		case "task":
...
func (this *Service) String() string {
	...
	s := strings.Join([]string{`&Service{`,
		...
		`StaticInfo:` + strings.Replace(fmt.Sprintf("%v", this.StaticInfo), "StaticInfo", "StaticInfo", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PeerGroup) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PeerGroup{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "PeerGroupSpec", "PeerGroupSpec", 1), `&`, ``, 1) + `,`,
		`Endpoint:` + strings.Replace(fmt.Sprintf("%v", this.Endpoint), "Endpoint", "Endpoint", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CertificateAuthority) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CertificateAuthority{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "CertificateAuthoritySpec", "CertificateAuthoritySpec", 1), `&`, ``, 1) + `,`,
...
func (this *Task) String() string {
	...
	s := strings.Join([]string{`&Task{`,
		...
		`IsStandalone:` + fmt.Sprintf("%v", this.IsStandalone) + `,`,
		`MaterializedConfigs:` + strings.Replace(fmt.Sprintf("%v", this.MaterializedConfigs), "ConfigReference", "ConfigReference", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *StaticInfo) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StaticInfo{`,
		`Message:` + fmt.Sprintf("%v", this.Message) + `,`,
		`NodeID:` + fmt.Sprintf("%v", this.NodeID) + `,`,
		`NetworkAttachment:` + strings.Replace(fmt.Sprintf("%v", this.NetworkAttachment), "NetworkAttachment", "NetworkAttachment", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Service) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StaticInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.StaticInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Task) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			...
			m.MaterializedConfigs = append(m.MaterializedConfigs, &ConfigReference{})
			if err := m.MaterializedConfigs[len(m.MaterializedConfigs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StaticInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StaticInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StaticInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetworkAttachment", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NetworkAttachment.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorObjects = []byte{
	...
	,
}
