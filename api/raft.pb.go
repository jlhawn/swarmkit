...
type StoreAction struct {
	...
	//	*StoreAction_Config
	//	*StoreAction_PeerGroup
	//	*StoreAction_CertificateAuthority
...
type StoreAction_PeerGroup struct {
	PeerGroup *PeerGroup `protobuf:"bytes,11,opt,name=peer_group,json=peerGroup,oneof"`
}
type StoreAction_CertificateAuthority struct {
	CertificateAuthority *CertificateAuthority `protobuf:"bytes,12,opt,name=certificate_authority,json=certificateAuthority,oneof"`
}
...
func (*StoreAction_PeerGroup) isStoreAction_Target()            {}
func (*StoreAction_CertificateAuthority) isStoreAction_Target() {}
...
func (m *StoreAction) GetPeerGroup() *PeerGroup {
	if x, ok := m.GetTarget().(*StoreAction_PeerGroup); ok {
		return x.PeerGroup
	}
	return nil
}

func (m *StoreAction) GetCertificateAuthority() *CertificateAuthority {
	if x, ok := m.GetTarget().(*StoreAction_CertificateAuthority); ok {
...
func (*StoreAction) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _StoreAction_OneofMarshaler, _StoreAction_OneofUnmarshaler, _StoreAction_OneofSizer, []interface{}{
		...
		(*StoreAction_PeerGroup)(nil),
		(*StoreAction_CertificateAuthority)(nil),
	}
}
...
func _StoreAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 10: // target.config
		...
		return true, err
	case 11: // target.peer_group
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PeerGroup)
		err := b.DecodeMessage(msg)
		m.Target = &StoreAction_PeerGroup{msg}
		return true, err
	case 12: // target.certificate_authority
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CertificateAuthority)
		err := b.DecodeMessage(msg)
		m.Target = &StoreAction_CertificateAuthority{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *StoreAction_PeerGroup) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PeerGroup != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintRaft(dAtA, i, uint64(m.PeerGroup.Size()))
		n15, err := m.PeerGroup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *StoreAction_CertificateAuthority) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CertificateAuthority != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintRaft(dAtA, i, uint64(m.CertificateAuthority.Size()))
		n16, err := m.CertificateAuthority.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *StoreAction_PeerGroup) Size() (n int) {
	var l int
	_ = l
	if m.PeerGroup != nil {
		l = m.PeerGroup.Size()
...
func (m *StoreAction_CertificateAuthority) Size() (n int) {
	var l int
	_ = l
	if m.CertificateAuthority != nil {
...
func (this *StoreAction_PeerGroup) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreAction_PeerGroup{`,
		`PeerGroup:` + strings.Replace(fmt.Sprintf("%v", this.PeerGroup), "PeerGroup", "PeerGroup", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StoreAction_CertificateAuthority) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreAction_CertificateAuthority{`,
...
func (m *StoreAction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Target = &StoreAction_PeerGroup{v}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
			...
			m.Target = &StoreAction_CertificateAuthority{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaft(dAtA[iNdEx:])
...
var fileDescriptorRaft = []byte{
	...
	,
}
