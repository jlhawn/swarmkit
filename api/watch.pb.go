...
type Object_PeerGroup struct {
	PeerGroup *PeerGroup `protobuf:"bytes,10,opt,name=peer_group,json=peerGroup,oneof"`
}
type Object_CertificateAuthority struct {
	CertificateAuthority *CertificateAuthority `protobuf:"bytes,11,opt,name=certificate_authority,json=certificateAuthority,oneof"`
}
...
func (*Object_PeerGroup) isObject_Object()            {}
func (*Object_CertificateAuthority) isObject_Object() {}
...
func (m *Object) GetPeerGroup() *PeerGroup {
	if x, ok := m.GetObject().(*Object_PeerGroup); ok {
		return x.PeerGroup
	}
	return nil
}

func (m *Object) GetCertificateAuthority() *CertificateAuthority {
	if x, ok := m.GetObject().(*Object_CertificateAuthority); ok {
...
func (*Object) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Object_OneofMarshaler, _Object_OneofUnmarshaler, _Object_OneofSizer, []interface{}{
		...
		(*Object_Config)(nil),
		(*Object_PeerGroup)(nil),
		(*Object_CertificateAuthority)(nil),
	}
}
...
func _Object_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Object_PeerGroup:
		_ = b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PeerGroup); err != nil {
			return err
		}
	case *Object_CertificateAuthority:
		_ = b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CertificateAuthority); err != nil {
			return err
		}
	case nil:
	default:
...
func _Object_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 9: // Object.config
		...
		return true, err
	case 10: // Object.peer_group
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PeerGroup)
		err := b.DecodeMessage(msg)
		m.Object = &Object_PeerGroup{msg}
		return true, err
	case 11: // Object.certificate_authority
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CertificateAuthority)
		err := b.DecodeMessage(msg)
		m.Object = &Object_CertificateAuthority{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Object_OneofSizer(msg proto.Message) (n int) {
	...
	case *Object_Config:
		...
		n += s
	case *Object_PeerGroup:
		s := proto.Size(x.PeerGroup)
		n += proto.SizeVarint(10<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Object_CertificateAuthority:
		s := proto.Size(x.CertificateAuthority)
	...
	*m = *o
	if o.Object != nil {
		...
		case *Object_PeerGroup:
			...
			github_com_docker_swarmkit_api_deepcopy.Copy(v.PeerGroup, o.GetPeerGroup())
			m.Object = &v
		case *Object_CertificateAuthority:
			v := Object_CertificateAuthority{
				CertificateAuthority: &CertificateAuthority{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.CertificateAuthority, o.GetCertificateAuthority())
			m.Object = &v
		}
	}
...
func (m *Object_PeerGroup) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PeerGroup != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintWatch(dAtA, i, uint64(m.PeerGroup.Size()))
		n11, err := m.PeerGroup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *Object_CertificateAuthority) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CertificateAuthority != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintWatch(dAtA, i, uint64(m.CertificateAuthority.Size()))
		n12, err := m.CertificateAuthority.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *SelectBy) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.By != nil {
		nn13, err := m.By.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
...
func (m *SelectBy_Custom) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Custom != nil {
		...
		n14, err := m.Custom.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *SelectBy_CustomPrefix) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CustomPrefix != nil {
		...
		n15, err := m.CustomPrefix.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *SelectBy_Slot) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Slot != nil {
		...
		n16, err := m.Slot.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *WatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResumeFrom != nil {
		...
		n17, err := m.ResumeFrom.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *WatchMessage_Event) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OldObject != nil {
		...
		n20, err := m.OldObject.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *Object_PeerGroup) Size() (n int) {
	var l int
	_ = l
	if m.PeerGroup != nil {
		l = m.PeerGroup.Size()
...
func (m *Object_CertificateAuthority) Size() (n int) {
	var l int
	_ = l
	if m.CertificateAuthority != nil {
...
func (this *Object_PeerGroup) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Object_PeerGroup{`,
		`PeerGroup:` + strings.Replace(fmt.Sprintf("%v", this.PeerGroup), "PeerGroup", "PeerGroup", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Object_CertificateAuthority) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Object_CertificateAuthority{`,
...
func (m *Object) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Object = &Object_CertificateAuthority{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorWatch = []byte{
	...
	,
}
