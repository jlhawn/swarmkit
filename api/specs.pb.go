...
func (EndpointSpec_ResolutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{12, 0}
}
...
type ServiceSpec_Static struct {
	Static *StaticService `protobuf:"bytes,10,opt,name=static,oneof"`
}

func (*ServiceSpec_Replicated) isServiceSpec_Mode() {}
func (*ServiceSpec_Global) isServiceSpec_Mode()     {}
func (*ServiceSpec_Static) isServiceSpec_Mode()     {}
...
func (m *ServiceSpec) GetStatic() *StaticService {
	if x, ok := m.GetMode().(*ServiceSpec_Static); ok {
		return x.Static
	}
	return nil
}
...
func _ServiceSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 10: // mode.static
		...
		msg := new(StaticService)
		err := b.DecodeMessage(msg)
		m.Mode = &ServiceSpec_Static{msg}
		return true, err
	default:
		return false, nil
	}
...
// StaticService sets the reconcilation target to always have a single task
// running on a predetermined node with a static network identity.
type StaticService struct {
	// PeerGroup specifies the ID of the peer group which this service is a
	// member of. This service will automatically be given a network attachment
	// on the PeerGroup's specified network.
	PeerGroup string `protobuf:"bytes,1,opt,name=peerGroup,proto3" json:"peerGroup,omitempty"`
	// Placement specifies node selection constraints. These are used to first
	// decide which node the task for this static service should be scheduled
	// on. The Task spec should not have a Placement section as this value will
	// override it. Tasks will always be assigned to the node which the static
	// service is initially assigned to and will never change, even if the
	// selected node no longer meets the placement constraints in the future
	// (hence the term "static").
	Placement *Placement `protobuf:"bytes,3,opt,name=placement" json:"placement,omitempty"`
}

func (m *StaticService) Reset()                    { *m = StaticService{} }
func (*StaticService) ProtoMessage()               {}
func (*StaticService) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{4} }

type PeerGroupSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// Network specifies network that this services in this peer group will use
	// to connect to their peers. This value must be a network ID and that
	// network will automatically be added to the network attachements list in
	// the services' task spec.
	Network string `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`
}

func (m *PeerGroupSpec) Reset()                    { *m = PeerGroupSpec{} }
func (*PeerGroupSpec) ProtoMessage()               {}
func (*PeerGroupSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{5} }

type CertificateAuthoritySpec struct {
	// Annotations contains the name which will be used as the subject of
	// the CA certificate.
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
}
...
func (*CertificateAuthoritySpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{6} }
...
func (*TaskSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{7} }
...
func (*ResourceReference) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{8} }
...
func (*GenericRuntimeSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{9} }
...
func (*NetworkAttachmentSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{10} }
...
type ContainerSpec struct {
	...
	CertificateIssuances []*CertificateIssuance `protobuf:"bytes,26,rep,name=certificate_issuances,json=certificateIssuances" json:"certificate_issuances,omitempty"`
...
func (*ContainerSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{11} }
...
func (*ContainerSpec_PullOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{11, 1}
}
...
func (*ContainerSpec_DNSConfig) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{11, 2} }
...
func (*EndpointSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{12} }
...
func (*NetworkSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{13} }
...
func (*ClusterSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{14} }
...
func (*SecretSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{15} }
...
func (*ConfigSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{16} }
...
func init() {
	...
	proto.RegisterType((*StaticService)(nil), "docker.swarmkit.v1.StaticService")
	proto.RegisterType((*PeerGroupSpec)(nil), "docker.swarmkit.v1.PeerGroupSpec")
	proto.RegisterType((*CertificateAuthoritySpec)(nil), "docker.swarmkit.v1.CertificateAuthoritySpec")
	...
	*m = *o
	...
	if o.Mode != nil {
		...
		case *ServiceSpec_Global:
			...
			m.Mode = &v
		case *ServiceSpec_Static:
			v := ServiceSpec_Static{
				Static: &StaticService{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Static, o.GetStatic())
			m.Mode = &v
		}
	}
...
func (m *StaticService) Copy() *StaticService {
	if m == nil {
		return nil
	}
	o := &StaticService{}
...
func (m *StaticService) CopyFrom(src interface{}) {
...
func (m *PeerGroupSpec) Copy() *PeerGroupSpec {
	if m == nil {
		return nil
	}
	o := &PeerGroupSpec{}
...
func (m *PeerGroupSpec) CopyFrom(src interface{}) {
...
func (m *CertificateAuthoritySpec) Copy() *CertificateAuthoritySpec {
	if m == nil {
		return nil
	}
	o := &CertificateAuthoritySpec{}
	o.CopyFrom(m)
	return o
}

func (m *CertificateAuthoritySpec) CopyFrom(src interface{}) {

	o := src.(*CertificateAuthoritySpec)
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Annotations, &o.Annotations)
}
...
func (m *ContainerSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.CertificateIssuances != nil {
		m.CertificateIssuances = make([]*CertificateIssuance, len(o.CertificateIssuances))
		for i := range m.CertificateIssuances {
			m.CertificateIssuances[i] = &CertificateIssuance{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.CertificateIssuances[i], o.CertificateIssuances[i])
		}
	}
...
func (m *ServiceSpec_Static) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Static != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Static.Size()))
		n10, err := m.Static.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *StaticService) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PeerGroup) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.PeerGroup)))
	...
	if m.Placement != nil {
		...
		n11, err := m.Placement.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *PeerGroupSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PeerGroupSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CertificateAuthoritySpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CertificateAuthoritySpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.Annotations.Size()))
	n13, err := m.Annotations.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n13
...
func (m *ContainerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StopGracePeriod != nil {
		...
		n23, err := m.StopGracePeriod.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.PullOptions != nil {
		...
		n24, err := m.PullOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.DNSConfig != nil {
		...
		n25, err := m.DNSConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.Healthcheck != nil {
		...
		n26, err := m.Healthcheck.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.Init != nil {
		...
		n28, err := m.Init.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if len(m.CertificateIssuances) > 0 {
		for _, msg := range m.CertificateIssuances {
			dAtA[i] = 0xd2
			i++
			dAtA[i] = 0x1
			i++
...
func (m *NetworkSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DriverConfig != nil {
		...
		n30, err := m.DriverConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.ConfigFrom != nil {
		nn32, err := m.ConfigFrom.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn32
...
func (m *ClusterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n34, err := m.AcceptancePolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
	...
	n35, err := m.Orchestration.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
	...
	n36, err := m.Raft.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	...
	n37, err := m.Dispatcher.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
	...
	n38, err := m.CAConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
	...
	n39, err := m.TaskDefaults.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
	...
	n40, err := m.EncryptionConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
...
func (m *SecretSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Driver != nil {
		...
		n43, err := m.Driver.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *ConfigSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Templating != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Templating.Size()))
		n45, err := m.Templating.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *ServiceSpec_Static) Size() (n int) {
	var l int
	_ = l
	if m.Static != nil {
		l = m.Static.Size()
...
func (m *PeerGroupSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (m *CertificateAuthoritySpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (m *ContainerSpec) Size() (n int) {
	...
	if len(m.CertificateIssuances) > 0 {
		for _, e := range m.CertificateIssuances {
			l = e.Size()
			n += 2 + l + sovSpecs(uint64(l))
		}
	}
...
func (this *ServiceSpec_Static) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceSpec_Static{`,
		`Static:` + strings.Replace(fmt.Sprintf("%v", this.Static), "StaticService", "StaticService", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *StaticService) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StaticService{`,
...
func (this *PeerGroupSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PeerGroupSpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
...
func (this *CertificateAuthoritySpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CertificateAuthoritySpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`CertificateIssuances:` + strings.Replace(fmt.Sprintf("%v", this.CertificateIssuances), "CertificateIssuance", "CertificateIssuance", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PeerGroupSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PeerGroupSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PeerGroupSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CertificateAuthoritySpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CertificateAuthoritySpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CertificateAuthoritySpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ContainerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CertificateIssuances", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CertificateIssuances = append(m.CertificateIssuances, &CertificateIssuance{})
			if err := m.CertificateIssuances[len(m.CertificateIssuances)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSpecs = []byte{
	...
	,
}
