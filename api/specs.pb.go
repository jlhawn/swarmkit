...
type StaticService struct {
	// PeerGroup declares the name of the peer group which this service is a
	// member of.
	PeerGroup string `protobuf:"bytes,1,opt,name=PeerGroup,proto3" json:"PeerGroup,omitempty"`
	// PeerNetwork specifies network that this server will use to connect to
	// its peers. This value must be a network ID and that network must be in
	// the network attachements list in the service task spec.
	PeerNetwork string `protobuf:"bytes,2,opt,name=PeerNetwork,proto3" json:"PeerNetwork,omitempty"`
...
func (m *StaticService) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PeerNetwork) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.PeerNetwork)))
		i += copy(dAtA[i:], m.PeerNetwork)
	}
	if m.Placement != nil {
		dAtA[i] = 0x2a
		i++
...
func (this *StaticService) String() string {
	...
	s := strings.Join([]string{`&StaticService{`,
		...
		`PeerNetwork:` + fmt.Sprintf("%v", this.PeerNetwork) + `,`,
...
func (m *StaticService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PeerNetwork = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
...
var fileDescriptorSpecs = []byte{
	...
	,
}
