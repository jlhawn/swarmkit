...
type CertificateIssuance struct {
	// CertificateAuthorityID references the ID of the specific CA that will
	// issue a certificate.
	...
	// CertificateAuthorityName references the Name of the specific CA that
	// will issue a certificate.
	CertificateAuthorityName string `protobuf:"bytes,2,opt,name=certificate_authority_name,json=certificateAuthorityName,proto3" json:"certificate_authority_name,omitempty"`
	// Directory specifies the name of the directory which contains the
	// following files:
	// - key.pem
	// - cert.pem
	// - ca.pem
	// Each of which will have the same owner and be read-only.
	Directory *FileTarget `protobuf:"bytes,3,opt,name=directory" json:"directory,omitempty"`
}

func (m *CertificateIssuance) Reset()                    { *m = CertificateIssuance{} }
func (*CertificateIssuance) ProtoMessage()               {}
func (*CertificateIssuance) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{50} }
...
func init() {
	...
	proto.RegisterType((*CertificateIssuance)(nil), "docker.swarmkit.v1.CertificateIssuance")
...
func (m *CertificateIssuance) Copy() *CertificateIssuance {
	if m == nil {
		return nil
	}
	o := &CertificateIssuance{}
	o.CopyFrom(m)
	return o
}

func (m *CertificateIssuance) CopyFrom(src interface{}) {

	o := src.(*CertificateIssuance)
	*m = *o
	if o.Directory != nil {
		m.Directory = &FileTarget{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Directory, o.Directory)
	}
}
...
func (m *CertificateIssuance) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CertificateIssuance) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.CertificateAuthorityID) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.CertificateAuthorityID)))
		i += copy(dAtA[i:], m.CertificateAuthorityID)
	}
	if len(m.CertificateAuthorityName) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.CertificateAuthorityName)))
		i += copy(dAtA[i:], m.CertificateAuthorityName)
	}
	if m.Directory != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Directory.Size()))
		n40, err := m.Directory.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *CertificateIssuance) Size() (n int) {
	var l int
	_ = l
	...
	l = len(m.CertificateAuthorityName)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.Directory != nil {
...
func (this *CertificateIssuance) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CertificateIssuance{`,
		`CertificateAuthorityID:` + fmt.Sprintf("%v", this.CertificateAuthorityID) + `,`,
		`CertificateAuthorityName:` + fmt.Sprintf("%v", this.CertificateAuthorityName) + `,`,
		`Directory:` + strings.Replace(fmt.Sprintf("%v", this.Directory), "FileTarget", "FileTarget", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CertificateIssuance) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CertificateIssuance: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CertificateIssuance: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CertificateAuthorityName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CertificateAuthorityName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
